    ...
    <div class="container">
      <div class="row footer-top">
        <div class="col-sm-5 col-lg-5">
          ...
          <div class="text-md">
            <a v-for="item in contacts" v-bind:key="item" v-title="item.title" :href="item.link" :style="contactStyle" target="_blank">
          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li v-for="item in sponsor.list" v-bind:key="item">
            ...
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li v-for="item in statistics.list" v-bind:key="item">{{ item.title }}: {{ item.description }}</li>
              </ul>
            </div>
            ...
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li v-for="item in other.list" v-bind:key="item">
